...
<html>
	...
	<body>
		<a href="#edit-inscricao" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-inscricao" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:inscricaoInstance, action:'update']" method="PUT" >
